    ...
    return (
        <div className="min-h-[calc(100vh-80px)] w-full flex items-center justify-center p-6 pb-24 relative overflow-hidden">
            ...
            <div className="w-full max-w-[420px] bg-white rounded-[2rem] p-8 md:p-12 shadow-2xl shadow-black/5 relative hover:shadow-[#C9111E]/5 transition-shadow duration-500">
                ...
                <div className="absolute top-0 right-0 w-16 h-16 bg-[#F5F5F7] rounded-bl-full -z-10"></div>
                ...
                <form className="space-y-6">
                    ...
                    <button
                        type="button"
                        className="w-full bg-[#E8E8E8] text-[#C9111E] hover:bg-[#dedede] transition-colors rounded-full h-14 font-bold text-sm tracking-wider flex items-center justify-center gap-2 mt-4"
                    >
                        Join Membership
                ...
                <div className="mt-8 border-t border-gray-100 pt-6 text-center">
                    <p className="text-xs font-medium text-gray-500">
                        Already a member? <Link to="/login" className="text-[#C9111E] font-bold hover:underline">Log in</Link>
                    </p>
                </div>
            </div>
